...
export default function AuthPage() {
  ...
  const handleGuestAccess = async () => {
    try {
      ...
      // Create a guest token that mimics JWT structure
      const guestToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiJndWVzdCIsImlhdCI6MTczNDE5NzE5OSwiZXhwIjoxNzM0MjAzNTk5fQ.guest-signature'
